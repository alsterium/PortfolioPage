!(function () {
    ...
    function r() {
      return (
        ...
        i.renderbufferStorage(B, 33189, k, k),
        i.framebufferRenderbuffer(E, 36096, B, A),
        (y = i.createTexture()),
        i.bindTexture(R, y),
        i.texImage2D(R, 0, 6408, k, k, 0, 6408, 5121, null),
        i.texParameteri(R, 10240, 9728),
        i.texParameteri(R, 10241, 9728),
        i.texParameteri(R, 10242, 10497),
        i.texParameteri(R, 10243, 10497),
